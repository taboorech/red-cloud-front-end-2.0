...
const ActivityRow = ({ activity }: { activity: AIActivity }) => {
  ...
  return (
    <div className="flex items-center justify-between gap-4 p-4 bg-app-soft border border-app-line rounded-2xl">
      <div className="flex items-center gap-4 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-app-text-muted">{contentTypeLabel}</p>
        </div>
      </div>
      <div className="flex items-center gap-4 shrink-0 text-xs text-app-text-muted">
